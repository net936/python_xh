...
class Thing(models.Model):
    ...
    cailiao = models.CharField(max_length=150, blank=True, null=True)
    yanse = models.CharField(max_length=100, blank=True, null=True)
    baozhuang = models.CharField(max_length=10, blank=True, null=True)
    zhishu = models.CharField(max_length=50, blank=True, null=True)
    status = models.CharField(max_length=1, choices=STATUS_CHOICES, default='0')
    create_time = models.DateTimeField(auto_now_add=True, null=True)
