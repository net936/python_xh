      ...
      <div class="detail-content">
        <div class="detail-content-top">
          ...
          <div class="top-right">
            ...
            <div class="meta">材料：{{ detailData.cailiao }}</div>
            <div class="meta">颜色：{{ detailData.yanse }}</div>
            <div class="meta">包装：{{ detailData.baozhuang }}</div>
            <div class="meta">枝数：{{ detailData.zhishu }}枝</div>
